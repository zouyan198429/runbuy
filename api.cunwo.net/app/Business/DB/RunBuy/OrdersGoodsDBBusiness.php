...
//            throws('操作失败；信息[' . $e->getMessage() . ']');
     ...
     * @author zouyan(305463219@qq.com)
     */
    public static function finishGoodsOrders($order_no, $operate_staff_id, $operate_staff_id_history){
        // 获得订单商品
        $queryGoodsParams = [
            'where' => [
                //  ['order_type', 4],// 订单类型1普通订单/父订单4子订单
        ...
        $goodsList = OrdersGoodsDBBusiness::getAllList($queryGoodsParams, []);
