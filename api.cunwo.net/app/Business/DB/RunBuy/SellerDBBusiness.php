 ...
 *
 */
class SellerDBBusiness extends BasePublicDBBusiness
{
    ...
    public static function getIdHistory($mainId = 0, &$mainDBObj = null, &$historyDBObj = null){
        // $mainDBObj = null ;
        // $historyDBObj = null ;
        return static::getHistoryId($mainDBObj, $mainId, SellerHistoryDBBusiness::$model_name
            , SellerHistoryDBBusiness::$table_name, $historyDBObj, ['seller_id' => $mainId], []);
    }
    ...
    public static function compareHistory($id = 0, $forceIncVersion = 0, &$mainDBObj = null, &$historyDBObj = null){
        ...
        // $mainDBObj = null ;
        // $historyDBObj = null ;
        return static::compareHistoryOrUpdateVersion($mainDBObj, $id, SellerHistoryDBBusiness::$model_name
            , SellerHistoryDBBusiness::$table_name, $historyDBObj, $historySearch, ['seller_id'], $forceIncVersion);
    }
...
//        }
        ...
        if(is_numeric($city_partner_id) && $city_partner_id > 0 && $city_site_id <= 0){
            $partnerInfo = CityPartnerDBBusiness::getInfo($city_partner_id,['city_site_id']);
