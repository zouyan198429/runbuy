 ...
 *
 */
class ShopGoodsPropsDBBusiness extends BasePublicDBBusiness
{
    public static $model_name = 'RunBuy\ShopGoodsProps';
    ...
    public static function getIdHistory($mainId = 0, &$mainDBObj = null, &$historyDBObj = null){
        // $mainDBObj = null ;
        // $historyDBObj = null ;
        return static::getHistoryId($mainDBObj, $mainId, ShopGoodsPropsHistoryDBBusiness::$model_name
            , ShopGoodsPropsHistoryDBBusiness::$table_name, $historyDBObj, ['goods_props_id' => $mainId], []);
    }
    ...
    public static function compareHistory($id = 0, $forceIncVersion = 0, &$mainDBObj = null, &$historyDBObj = null){
        ...
        // $mainDBObj = null ;
        // $historyDBObj = null ;
        return static::compareHistoryOrUpdateVersion($mainDBObj, $id, ShopGoodsPropsHistoryDBBusiness::$model_name
            , ShopGoodsPropsHistoryDBBusiness::$table_name, $historyDBObj, $historySearch, ['goods_props_id'], $forceIncVersion);
    }
    ...
    //                            ],
            ...
            // 更新购物车属性表值
            CartGoodsPropsDBBusiness::bathModifyByProp($names_id, $prop_id, $prop_val_id, $operate_staff_id, $operate_staff_id_history);
            // 更新版本号
