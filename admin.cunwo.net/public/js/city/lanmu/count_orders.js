...
(function() {
    ...
    document.write("        <td><%=item.record_num%><\/td>");
    document.write("        <td>￥<%=item.total_run_price%><\/td>");
    document.write("        <td><%=item.total_amount%><\/td>");
    document.write("        <td>￥<%=item.total_price%><\/td>");
    document.write("    <\/tr>");
    document.write("    <%}%>");
