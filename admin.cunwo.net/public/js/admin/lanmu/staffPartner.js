...
(function() {
    ...
    // document.write("            <td><%=item.seller_name%>|<%=item.shop_name%><\/td>");
    document.write("            <td><%=item.admin_username%>|<%=item.real_name%><\/td>");
    document.write("            <td><%=item.admin_type_text%>|<%=item.sex_text%><\/td>");
    document.write("            <td><%=item.tel%>|<%=item.mobile%><\/td>");
    // document.write("            <td><%=item.qq_number%>|<%=item.province_name%><%=item.city_name%><%=item.area_name%><%=item.addr%><\/td>");
    document.write("           <td>");
    ...
    document.write("           <\/td>");
    document.write("            <td><%=item.issuper_text%>|<%=item.account_status_text%><\/td>");
