...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.site_name%>|<%=item.partner_name%>|<%=item.seller_name%><\/td>");
    document.write("            <td><a alt=\"<%=item.addr%> \"> <%=item.shop_name%> </a><\/td>");
   ...
   // document.write("           <td>");
   // document.write("            <%=item.area_name%>");
    // document.write("            <%=item.longitude%><br/><%=item.latitude%>|");
    //document.write("           <\/td>");
    document.write("            <td><%=item.type_name%>|<%=item.labelNnames%><\/td>");
    document.write("            <td><%=item.sales_volume%>|<%=item.mon_sales_volume%>|<%=item.last_update%><\/td>");
    // document.write("           <td>");
    ...
    // // document.write("                <\/a>");
    // document.write("           <\/td>");
    document.write("            <td><%=item.sort_num%>|<%=item.per_price%>|<%=item.status_text%>|<%=item.status_business_text%><\/td>");
    ...
    document.write("                    <i class=\"ace-icon fa fa-cubes bigger-60\"> 商品分类<\/i>");
    document.write("                <\/a>");
