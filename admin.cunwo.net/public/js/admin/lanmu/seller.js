...
//业务逻辑部分
var otheraction = {
    staffSeller: function(obj, city_site_id, city_partner_id, seller_id, text){// 帐号管理
        var obj = $(obj);
        var href = STAFF_SELLER_LIST_URL + '?city_site_id=' + city_site_id + '&city_partner_id=' + city_partner_id + '&seller_id=' + seller_id;//
        layuiGoIframe(href, text);
        return false;
    },
    shop: function(obj, city_site_id, city_partner_id, seller_id, text){// 店铺管理
        var obj = $(obj);
        var href = SHOP_LIST_URL + '?city_site_id=' + city_site_id + '&city_partner_id=' + city_partner_id + '&seller_id=' + seller_id;//
        layuiGoIframe(href, text);
        return false;
    },
    goods: function(obj, city_site_id, city_partner_id, seller_id, text){// 商品管理
        var obj = $(obj);
        var href = GOODS_LIST_URL + '?city_site_id=' + city_site_id + '&city_partner_id=' + city_partner_id + '&seller_id=' + seller_id;//
        layuiGoIframe(href, text);
        return false;
    },
...
(function() {
   ...
   // document.write("        if( item.issuper==0 ){");
    ...
    document.write("            <td><%=item.city_site_name%><\/td>");
