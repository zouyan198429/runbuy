...
(function() {
    ...
    document.write("            <td><%=item.real_name%>:<%=item.mobile%><\/td>");
    ...
    document.write("                <img  src=\"<%=item.avatar_url%>\"  style=\"width:30px;\">");
    // document.write("              </a>");
    document.write("           <\/td>");
    ...
    document.write("            <td><%=item.created_at%>|<%=item.updated_at%><\/td>");
    document.write("            <td >");
