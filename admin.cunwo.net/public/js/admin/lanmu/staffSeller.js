...
(function() {
    ...
    document.write("            <td><%=item.seller_name%><\/td>"); //<hr/><%=item.shop_name%>
    document.write("            <td><%=item.admin_username%>/<%=item.real_name%>(<%=item.sex_text%>)<\/td>");
    //document.write("            <td><%=item.admin_type_text%><\/td>");
