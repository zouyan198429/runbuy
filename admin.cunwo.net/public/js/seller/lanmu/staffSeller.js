...
(function() {
    ...
    document.write("            <td><%=item.admin_username%><\/td><td><%=item.real_name%><\/td>");
    document.write("            <td><%=item.admin_type_text%><\/td><td><%=item.sex_text%><\/td>");
    document.write("            <td><%=item.tel%><\/td><td><%=item.mobile%><\/td>");
    ...
    document.write("            <\/td><td><%=item.province_name%><%=item.city_name%><%=item.area_name%><%=item.addr%>");
    document.write("            <\/td><td><%=item.longitude%><br/><%=item.latitude%>");
    document.write("           <\/td>");
    document.write("            <td><%=item.issuper_text%><\/td><td><%=item.account_status_text%><\/td>");
