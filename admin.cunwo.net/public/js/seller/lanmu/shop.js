...
//    document.write("            <td><%=item.site_name%><hr/><%=item.partner_name%><hr/><%=item.seller_name%><\/td>");
    document.write("            <td><%=item.shop_name%><\/td><td><%=item.linkman%><\/td>");
    document.write("            <td><%=item.mobile%>| <%=item.tel%><\/td>");
    // document.write("            <td><%=item.province_name%><%=item.city_name%><%=item.area_name%><%=item.addr%><\/td>");
    document.write("           <td>");
    document.write("            <%=item.province_name%><%=item.city_name%><%=item.area_name%><%=item.addr%><\/td><td>");
  //  document.write("            <%=item.longitude%><br/><%=item.latitude%><hr/>");
    ...
    document.write("            <td><%=item.type_name%><\/td><td><%=item.labelNnames%><\/td>");
    document.write("            <td><%=item.sales_volume%>|<%=item.mon_sales_volume%><\/td><td><%=item.last_update%><\/td>");
    document.write("           <td>");
    ...
    // document.write("                <\/a>");
    document.write("           <\/td>");
    document.write("            <td><%=item.sort_num%><\/td><td><%=item.per_price%><\/td><td><%=item.status_text%><\/td><td><%=item.status_business_text%><\/td>");
    ...
    document.write("                    <i class=\"ace-icon fa fa-pencil bigger-60\"> 帐号编辑<\/i>");
    document.write("                <\/a>");
    document.write("                <a href=\"https://shop.jidiwang.com/\" target=\"_blank\" class=\"btn btn-mini btn-info\" >");
    document.write("                    <i class=\"ace-icon fa fa-pencil bigger-60\"> 内容管理<\/i>");
    document.write("                <\/a>");
