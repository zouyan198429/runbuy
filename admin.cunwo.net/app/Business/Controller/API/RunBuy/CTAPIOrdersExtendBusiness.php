...
class CTAPIOrdersExtendBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\OrdersExtendAPI';
    public static $table_name = 'orders_extend';// 表名称
