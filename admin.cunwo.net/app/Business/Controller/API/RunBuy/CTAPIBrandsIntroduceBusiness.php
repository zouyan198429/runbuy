...
class CTAPIBrandsIntroduceBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\BrandsIntroduceAPI';
    public static $table_name = 'brands_introduce';// 表名称
