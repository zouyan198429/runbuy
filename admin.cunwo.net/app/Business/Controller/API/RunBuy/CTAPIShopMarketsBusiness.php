...
class CTAPIShopMarketsBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\ShopMarketsAPI';
    public static $table_name = 'shop_markets';// 表名称
