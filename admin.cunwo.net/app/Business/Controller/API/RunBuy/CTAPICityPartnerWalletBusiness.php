...
class CTAPICityPartnerWalletBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\CityPartnerWalletAPI';
    public static $table_name = 'city_partner_wallet';// 表名称
