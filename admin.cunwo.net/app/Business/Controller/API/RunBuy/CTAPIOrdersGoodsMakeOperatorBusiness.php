...
class CTAPIOrdersGoodsMakeOperatorBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\OrdersGoodsMakeOperatorAPI';
    public static $table_name = 'orders_goods_make_operator';// 表名称
