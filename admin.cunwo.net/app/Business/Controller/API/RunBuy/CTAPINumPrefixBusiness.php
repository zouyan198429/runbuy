...
class CTAPINumPrefixBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\NumPrefixAPI';
    public static $table_name = 'num_prefix';// 表名称
...
//            'select' => [
//                'id','company_id','prefix_name','sort_num'
//                //,'operate_staff_id','operate_staff_id_history'
//                ,'created_at'
//            ],
//            'orderBy' => ['sort_num'=>'desc','id'=>'desc'],
...
//        ];
    ...
    public static function getCityByPid(Request $request, Controller $controller, $parent_id = 0, $notLog = 0){
        $company_id = $controller->company_id;
        $kvParams = ['key' => 'id', 'val' => 'prefix_name'];
        $queryParams = [
            'where' => [
                // ['id', '&' , '16=16'],
                //    ['parent_id', '=', $parent_id],
