...
class CTAPIShopWalletBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\ShopWalletAPI';
    public static $table_name = 'shop_wallet';// 表名称
