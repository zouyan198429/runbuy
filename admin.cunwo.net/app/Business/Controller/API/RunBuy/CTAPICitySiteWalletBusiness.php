...
class CTAPICitySiteWalletBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\CitySiteWalletAPI';
    public static $table_name = 'city_site_wallet';// 表名称
