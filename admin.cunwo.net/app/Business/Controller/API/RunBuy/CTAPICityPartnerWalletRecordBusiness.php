...
class CTAPICityPartnerWalletRecordBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\CityPartnerWalletRecordAPI';
    public static $table_name = 'city_partner_wallet_record';// 表名称
