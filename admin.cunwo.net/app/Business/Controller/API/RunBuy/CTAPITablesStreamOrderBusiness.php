...
class CTAPITablesStreamOrderBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\TablesStreamOrderAPI';
    public static $table_name = 'tables_stream_order';// 表名称
