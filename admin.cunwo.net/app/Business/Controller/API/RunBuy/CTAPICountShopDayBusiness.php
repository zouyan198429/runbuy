...
class CTAPICountShopDayBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\CountShopDayAPI';
    public static $table_name = 'count_shop_day';// 表名称
