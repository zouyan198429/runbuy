...
class CTAPIOrdersMakeGoodsBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\OrdersMakeGoodsAPI';
    public static $table_name = 'orders_make_goods';// 表名称
