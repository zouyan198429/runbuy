...
class CTAPIProjectsPaymentConfigBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\ProjectsPaymentConfigAPI';
    public static $table_name = 'projects_payment_config';// 表名称
