...
class CTAPIGradeTableBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\GradeTableAPI';
    public static $table_name = 'grade_table';// 表名称
