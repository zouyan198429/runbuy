...
class CTAPIShopChargeRecordBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\ShopChargeRecordAPI';
    public static $table_name = 'shop_charge_record';// 表名称
