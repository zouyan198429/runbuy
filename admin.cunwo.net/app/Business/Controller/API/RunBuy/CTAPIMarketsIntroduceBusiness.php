...
class CTAPIMarketsIntroduceBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\MarketsIntroduceAPI';
    public static $table_name = 'markets_introduce';// 表名称
