...
class CTAPIShopWalletRecordBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\ShopWalletRecordAPI';
    public static $table_name = 'shop_wallet_record';// 表名称
