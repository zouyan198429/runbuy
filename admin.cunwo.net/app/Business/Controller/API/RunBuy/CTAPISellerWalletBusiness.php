...
class CTAPISellerWalletBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\SellerWalletAPI';
    public static $table_name = 'seller_wallet';// 表名称
