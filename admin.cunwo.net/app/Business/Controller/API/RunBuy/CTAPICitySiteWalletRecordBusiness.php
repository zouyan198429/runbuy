...
class CTAPICitySiteWalletRecordBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\CitySiteWalletRecordAPI';
    public static $table_name = 'city_site_wallet_record';// 表名称
