...
class CTAPITablesStreamUserBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\TablesStreamUserAPI';
    public static $table_name = 'tables_stream_user';// 表名称
