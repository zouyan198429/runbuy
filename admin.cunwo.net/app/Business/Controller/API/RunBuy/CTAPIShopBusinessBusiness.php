...
class CTAPIShopBusinessBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\ShopBusinessAPI';
    public static $table_name = 'shop_business';// 表名称
