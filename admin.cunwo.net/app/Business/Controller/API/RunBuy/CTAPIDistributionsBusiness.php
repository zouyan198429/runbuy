...
class CTAPIDistributionsBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\DistributionsAPI';
    public static $table_name = 'distributions';// 表名称
