...
class CTAPIOrdersMakeBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\OrdersMakeAPI';
    public static $table_name = 'orders_make';// 表名称
