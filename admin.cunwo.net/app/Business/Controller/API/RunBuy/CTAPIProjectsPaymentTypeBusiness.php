...
class CTAPIProjectsPaymentTypeBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\ProjectsPaymentTypeAPI';
    public static $table_name = 'projects_payment_type';// 表名称
