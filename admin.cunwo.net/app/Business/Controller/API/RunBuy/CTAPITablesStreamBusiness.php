...
class CTAPITablesStreamBusiness extends BasicPublicCTAPIBusiness
{
    public static $model_name = 'API\RunBuy\TablesStreamAPI';
    public static $table_name = 'tables_stream';// 表名称
