...
//        pr($tableName);
    ...
    public function index(Request $request)
    {
        ...
        return view('seller.index', $reDataArr);
    }
    ...
    {
        $reDataArr = $this->reDataArr;
        return view('seller.login', $reDataArr);
    }
    ...
    public function password(Request $request)
    {
        ...
        return view('seller.admin.password', $reDataArr);
    }
    ...
    public function info(Request $request)
    {
        ...
        $reDataArr = array_merge($reDataArr, $user_info);
        return view('seller.admin.info', $reDataArr);
    }
    ...
    public function ajax_login(Request $request)
    {
        ...
        return CTAPIStaffBusiness::login($request, $this,8);
