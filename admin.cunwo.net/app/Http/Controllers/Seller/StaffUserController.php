...
class StaffUserController extends WorksController
{
    /**
     * 首页
     *
...
//        return view('seller.staffUser.index', $reDataArr);
        return view('seller.WXUser.index', $reDataArr);
    }
...
//        $reDataArr['province_kv'] = CTAPIStaffBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//        $reDataArr['province_id'] = 0;
//        return view('seller.staffUser.select', $reDataArr);
//    }
...
//        $reDataArr['province_kv'] = CTAPIStaffBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//        $reDataArr['province_id'] = 0;
        return view('seller.staffUser.add', $reDataArr);
    }
