...
class StaffSellerController extends WorksController
{
    /**
     * 首页
     *
    ...
    public function index(Request $request)
    {
        ...
        $reDataArr['admin_type'] =  8;// CommonRequest::getInt($request, 'admin_type');
        ...
        return view('seller.staffSeller.index', $reDataArr);
    }
...
//        $reDataArr['province_kv'] = CTAPIStaffBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//        $reDataArr['province_id'] = 0;
//        return view('seller.staffSeller.select', $reDataArr);
//    }
...
//        $reDataArr['province_kv'] = CTAPIStaffBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//        $reDataArr['province_id'] = 0;
        return view('seller.staffSeller.add', $reDataArr);
    }
