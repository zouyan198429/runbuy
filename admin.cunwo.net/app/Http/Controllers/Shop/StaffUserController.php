...
//        return view('shop.staffUser.index', $reDataArr);
        return view('shop.WXUser.index', $reDataArr);
    }
...
//        $reDataArr['province_kv'] = CTAPIStaffBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//        $reDataArr['province_id'] = 0;
//        return view('shop.staffUser.select', $reDataArr);
//    }
...
//        $reDataArr['province_kv'] = CTAPIStaffBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//        $reDataArr['province_id'] = 0;
        return view('shop.staffUser.add', $reDataArr);
    }
