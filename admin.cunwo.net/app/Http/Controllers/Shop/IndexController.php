...
//        pr($tableName);
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.index', $reDataArr);
    }
    ...
    {
        $reDataArr = $this->reDataArr;
        return view('shop.login', $reDataArr);
    }
    ...
    public function password(Request $request)
    {
        ...
        return view('shop.admin.password', $reDataArr);
    }
    ...
    public function info(Request $request)
    {
        ...
        $reDataArr = array_merge($reDataArr, $user_info);
        return view('shop.admin.info', $reDataArr);
    }
    ...
    public function ajax_login(Request $request)
    {
        ...
        return CTAPIStaffBusiness::login($request, $this,16);
