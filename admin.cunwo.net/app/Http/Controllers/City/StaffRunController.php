...
class StaffRunController extends WorksController
{
    /**
     * 首页
     *
    ...
    public function index(Request $request)
    {
        ...
        $reDataArr['city_partner_id'] =  CommonRequest::getInt($request, 'city_partner_id');// $this->city_partner_id;//
        $reDataArr['seller_id'] =  CommonRequest::getInt($request, 'seller_id');
        $reDataArr['shop_id'] =  CommonRequest::getInt($request, 'shop_id');
        // return view('city.staffRun.index', $reDataArr);
        return view('city.WXRun.index', $reDataArr);
    }
...
//        $reDataArr['province_kv'] = CTAPIStaffBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//        $reDataArr['province_id'] = 0;
//        return view('city.staffRun.select', $reDataArr);
//    }
...
//        $reDataArr['province_kv'] = CTAPIStaffBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//        $reDataArr['province_id'] = 0;
        return view('city.staffRun.add', $reDataArr);
    }
