...
//        pr($tableName);
    ...
    public function index(Request $request)
    {
        ...
        return view('city.index', $reDataArr);
    }
    ...
    {
        $reDataArr = $this->reDataArr;
        return view('city.login', $reDataArr);
    }
    ...
    public function password(Request $request)
    {
        ...
        return view('city.admin.password', $reDataArr);
    }
    ...
    public function info(Request $request)
    {
        ...
        $reDataArr = array_merge($reDataArr, $user_info);
        return view('city.admin.info', $reDataArr);
    }
    ...
    public function ajax_login(Request $request)
    {
        ...
        return CTAPIStaffBusiness::login($request, $this,4);
