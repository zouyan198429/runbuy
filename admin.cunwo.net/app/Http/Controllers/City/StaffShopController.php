...
class StaffShopController extends WorksController
{
    /**
     * 首页
     *
    ...
    public function index(Request $request)
    {
        ...
        $reDataArr['admin_type'] =  16;// CommonRequest::getInt($request, 'admin_type');
        ...
        return view('city.staffShop.index', $reDataArr);
    }
...
//        $reDataArr['province_kv'] = CTAPIStaffBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//        $reDataArr['province_id'] = 0;
//        return view('city.staffShop.select', $reDataArr);
//    }
...
//        $reDataArr['province_kv'] = CTAPIStaffBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//        $reDataArr['province_id'] = 0;
        return view('city.staffShop.add', $reDataArr);
    }
