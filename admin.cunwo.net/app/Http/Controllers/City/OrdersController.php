...
//    }
    ...
    public function countOrders(Request $request)
    {
        ...
        return view('city.orders.countOrders', $reDataArr);
    }
    ...
    public function ajax_count_orders(Request $request)
    {
        ...
        $city_site_id = $this->city_site_id;// CommonRequest::getInt($request, 'city_site_id');// 城市分站id
        $city_partner_id = $this->city_partner_id;// CommonRequest::getInt($request, 'city_partner_id');// 城市合伙人id
