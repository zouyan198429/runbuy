...
//        dump($request->get('url'));
    ...
    public function profile(){
        ...
        $wechat_user = Tool::getRedis('target_url', 2);
        Log::info('微信日志-登陆情况信息',[$wechat_user]);
//      if (empty($_SESSION['wechat_user'])) {
        if (empty($wechat_user)) {
            Log::info('微信日志-登陆',['未登陆']);
            // $_SESSION['target_url'] = 'user/profile';
            Tool::setRedis('', 'target_url', '/api/wx/profile', 60*5, 2); // 5分钟
        ...
        // 已经登录过
        $user = Tool::getRedis('wechat_user', 2);// $_SESSION['wechat_user'];
        echo '已经登录过';
    ...
    public function callback(){
        ...
        Tool::setRedis('', 'wechat_user', $wechat_user, 60*5, 2); // 5分钟
        /*
         *
            {
        ...
        $target_url = Tool::getRedis('target_url', 2);
