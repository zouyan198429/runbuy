...
class FeeScaleController extends BaseController
{
    ...
    public function ajax_alist(Request $request){
        ...
        return  CTAPIFeeScaleBusiness::getList($request, $this, 2 + 4, [], [ 'city', 'cityHistory']);
    }
    ...
    public function ajax_info(Request $request,$id = 0){
        ...
        $info = CTAPIFeeScaleBusiness::getInfoData($request, $this, $id, [], ['city', 'cityHistory'], []);// , ['city']
...
//            ],
        ...
        $info = CTAPIFeeScaleBusiness::getInfoByQuery($request, $this, '', $this->company_id, $queryParams , ['city' , 'cityHistory']);
