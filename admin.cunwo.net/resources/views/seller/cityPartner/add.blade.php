    ...
    <form class="am-form am-form-horizontal" method="post"  id="addForm">
        ...
        <table class="table1">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="inp wnormal"  name="partner_name" value="{{ $info['partner_name'] or '' }}" placeholder="请输入名称" />
                </td>
            </tr>
            <tr>
...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/seller/cityPartner/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('seller/cityPartner')}}";//保存成功后跳转到的地址
    ...
    var SELECT_CITY_URL = "{{ url('seller/city/select') }}";// 选择城市分站地址
    var AJAX_CITY_SELECTED_URL = "{{ url('api/seller/city/ajax_selected') }}";// ajax选中城市分站地址
</script>
<script src="{{ asset('/js/seller/lanmu/cityPartner_edit.js') }}"  type="text/javascript"></script>
</body>
</html>