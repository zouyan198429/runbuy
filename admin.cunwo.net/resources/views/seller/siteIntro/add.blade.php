...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/seller/siteIntro/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('seller/siteIntro')}}";//保存成功后跳转到的地址
</script>
<script src="{{ asset('/js/seller/lanmu/siteIntro_edit.js') }}"  type="text/javascript"></script>
</body>
</html>