...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/seller/tablePerson/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('seller/tablePerson')}}";//保存成功后跳转到的地址

    var SELECT_SHOP_URL = "{{ url('seller/shop/select') }}";// 选择店铺地址
    var AJAX_SHOP_SELECTED_URL = "{{ url('api/seller/shop/ajax_selected') }}";// ajax选中店铺地址
</script>
<script src="{{ asset('/js/seller/lanmu/tablePerson_edit.js') }}"  type="text/javascript"></script>
</body>
</html>