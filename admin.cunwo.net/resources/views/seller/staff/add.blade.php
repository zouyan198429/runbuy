...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/seller/staff/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('seller/staff')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/seller/lanmu/staff_edit.js') }}"  type="text/javascript"></script>
</body>
</html>