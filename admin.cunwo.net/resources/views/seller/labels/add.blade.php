...
<div class="mm">
    <form class="am-form am-form-horizontal" method="post"  id="addForm">
        ...
        <table class="table1">
            <tr>
                <th>标签名称<span class="must">*</span></th>
                <td>
                    <input type="text" class="inp wnormal"  name="type_name" value="{{ $info['type_name'] or '' }}" placeholder="请输入标签名称"/>
                </td>
            </tr>
            <tr>
...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/seller/labels/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('seller/labels')}}";//保存成功后跳转到的地址
</script>
<script src="{{ asset('/js/seller/lanmu/labels_edit.js') }}"  type="text/javascript"></script>
</body>
</html>