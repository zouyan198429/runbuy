...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/seller/shop/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('seller/shop')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/seller/lanmu/shop_edit.js') }}"  type="text/javascript"></script>
