...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/shop/staffShop/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('shop/staffShop')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/shop/lanmu/staffShop_edit.js') }}"  type="text/javascript"></script>
</body>
</html>