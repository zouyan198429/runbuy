...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/shop/prop/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('shop/prop')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/shop/lanmu/prop_edit.js') }}"  type="text/javascript"></script>
</body>
</html>