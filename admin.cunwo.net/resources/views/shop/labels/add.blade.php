...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/shop/labels/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('shop/labels')}}";//保存成功后跳转到的地址
</script>
<script src="{{ asset('/js/shop/lanmu/labels_edit.js') }}"  type="text/javascript"></script>
</body>
</html>