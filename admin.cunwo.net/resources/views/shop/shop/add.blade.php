...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/shop/shop/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('shop/shop')}}";//保存成功后跳转到的地址

    var SELECT_LATLNG_URL = "{{url('shop/qqMaps/latLngSelect')}}";//选择经纬度的地址
    ...
    var SELECT_SELLER_URL = "{{ url('shop/seller/select') }}";// 选择商家地址
    var AJAX_SELLER_SELECTED_URL = "{{ url('api/shop/seller/ajax_selected') }}";// ajax选中商家地址
...
<script src="{{ asset('/js/shop/lanmu/shop_edit.js') }}"  type="text/javascript"></script>
