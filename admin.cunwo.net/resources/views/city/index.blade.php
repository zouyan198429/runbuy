        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          ...
          <li class="layui-nav-item" lay-unselect>
            ...
            <dl class="layui-nav-child">
              <dd><a lay-href="{{ url('city/info') }}">基本资料</a></dd>
              <dd><a lay-href="{{ url('city/password') }}">修改密码</a></dd>
              <hr>
              <dd  style="text-align: center;"><a href="{{ url('city/logout') }}">退出</a></dd>
            </dl>
          </li>
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            ...
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                {{--
                <dd>
                  <a lay-href="{{ url('city/city') }}">城市管理</a>
                </dd>
                <dd>
                  <a lay-href="{{ url('city/cityPartner') }}">城市加盟商</a>
                </dd>
                --}}
            ...
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd>
                  <a lay-href="{{ url('city/seller') }}">商家</a>
                </dd>
              </dl>
            </li>
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd>
                  <a lay-href="{{ url('city/shop') }}">店铺管理</a>
                </dd>
              </dl>
            </li>
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd>
                  <a lay-href="{{ url('city/shopGoodsType') }}">商品分类</a>
                </dd>
                <dd>
                  <a lay-href="{{ url('city/prop') }}">商品属性</a>
                </dd>
                {{--<dd>--}}
                {{--<a lay-href="{{ url('layui/user/administrators/list') }}">商品规格</a>--}}
                {{--</dd>--}}
                <dd>
                  <a lay-href="{{ url('city/shopGoods') }}">商品</a>
                </dd>
              </dl>
            </li>
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                ...
                {{--</dd>--}}
                <dd>
                  <a lay-href="{{ url('city/order') }}">订单管理</a>
                </dd>
              </dl>
            </li>
            <li data-name="set" class="layui-nav-item">
            ...
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                {{--
                <dd>
                  <a lay-href="{{ url('city/staff') }}">后台管理员</a>
                </dd>
                --}}
                <dd>
                  <a lay-href="{{ url('city/staffPartner') }}">加盟商管理员</a>
                </dd>
                <dd>
