...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/city/tablePerson/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('city/tablePerson')}}";//保存成功后跳转到的地址

    var SELECT_SHOP_URL = "{{ url('city/shop/select') }}";// 选择店铺地址
    var AJAX_SHOP_SELECTED_URL = "{{ url('api/city/shop/ajax_selected') }}";// ajax选中店铺地址
</script>
<script src="{{ asset('/js/city/lanmu/tablePerson_edit.js') }}"  type="text/javascript"></script>
</body>
</html>