...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/city/shopGoods/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('city/shopGoods')}}";//保存成功后跳转到的地址
    ...
    var GOODS_TYPE_KV_URL  = "{{url('api/city/shopGoodsType/ajax_get_kv')}}";// 获得商品分类信息;根据店铺id，获得店铺分类信息
    ...
    var AJAX_PROP_URL = "{{ url('api/city/shopGoods/ajax_get_prop') }}";// ajax初始化属性地址
    var AJAX_UPDATE_PROP_URL = "{{ url('api/city/shopGoods/ajax_add_prop') }}";// ajax更新属性地址
    var AJAX_PROP_ADD_URL = "{{ url('api/city/shopGoods/ajax_add_prop') }}";// ajax添加属性地址

    var ADD_PROP_URL = "{{ url('city/prop/add/0') }}";// 新加属性地址
    var SELECT_PROP_URL = "{{ url('city/prop/select') }}";// 选择属性地址
    var AJAX_UPDATE_PROP_URL = "{{ url('api/city/prop/ajax_selected_multi') }}";// ajax更新参考人员地址
    var AJAX_PROP_SELECTED_URL = "{{ url('api/city/prop/ajax_selected') }}";// ajax选中属性地址-- 单选
    var AJAX_PROP_SELECTED_MULTI_URL = "{{ url('api/city/prop/ajax_selected_multi') }}";// ajax选中属性地址-- 复选
    ...
    // 上传图片变量
    var FILE_UPLOAD_URL = "{{ url('api/city/upload') }}";// 文件上传提交地址 'your/file/upload/url'
    var PIC_DEL_URL = "{{ url('api/city/upload/ajax_del') }}";// 删除图片url
...
<script src="{{ asset('/js/city/lanmu/shopGoods_edit.js') }}"  type="text/javascript"></script>
