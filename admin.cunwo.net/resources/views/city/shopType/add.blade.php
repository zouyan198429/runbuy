...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/city/shopType/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('city/shopType')}}";//保存成功后跳转到的地址
</script>
<script src="{{ asset('/js/city/lanmu/shopType_edit.js') }}"  type="text/javascript"></script>
</body>
</html>