...
<div id="crumb"><i class="fa fa-reorder fa-fw" aria-hidden="true"></i> 完成订单统计</div>
<div class="mm">
...
<script type="text/javascript" src="{{asset('js/common/graph.js')}}"></script>
  ...
  <script type="text/javascript">
      var COUNT_URL = "{{ url('api/admin/order/ajax_count_orders') }}";// ajax订单统计 url
      var BAR_GRAPH_ID = "container";// 柱状图id
      var BEGIN_DATE = "{{ $begin_date or '' }}" ;//开始日期
      var END_DATE = "{{ $end_date or '' }}" ;//结束日期
  </script>
    <script src="{{ asset('js/admin/lanmu/count_orders.js') }}"  type="text/javascript"></script>
</body>
</html>