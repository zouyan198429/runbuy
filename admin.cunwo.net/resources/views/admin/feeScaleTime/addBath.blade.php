...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/admin/feeScaleTime/ajax_save_bath') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/feeScaleTime')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/admin/lanmu/feeScaleTime_editBath.js') }}"  type="text/javascript"></script>
</body>
</html>