...
<div class="mm">
    <form class="am-form am-form-horizontal" method="post"  id="addForm">
        ...
        <table class="table1">
            <tr>
                <th>内容标题<span class="must">*</span></th>
                <td>
                    <input type="text" class="inp wnormal"  name="title" value="{{ $info['title'] or '' }}" placeholder="请输入内容标题" />
                </td>
            </tr>
            <tr>
                <th>内容<span class="must">*</span></th>
                <td>
                    <textarea class="kindeditor" name="content" rows="15" id="doc-ta-1" style=" width:800px;height:400px;">{!!  htmlspecialchars($info['content'] ?? '' )   !!}</textarea>
...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/admin/siteIntroRuner/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/siteIntroRuner')}}";//保存成功后跳转到的地址
</script>
<script src="{{ asset('/js/admin/lanmu/siteIntroRuner_edit.js') }}"  type="text/javascript"></script>
</body>
</html>