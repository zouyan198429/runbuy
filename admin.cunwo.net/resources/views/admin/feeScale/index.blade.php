...
--}}
  ...
  <script type="text/javascript">
      ...
      var AJAX_URL = "{{ url('api/admin/feeScale/ajax_alist') }}";//ajax请求的url
      ...
      var EDIT_URL = "{{url('admin/feeScale/add/')}}/";//修改页面地址前缀 + id
      var DEL_URL = "{{ url('api/admin/feeScale/ajax_del') }}";//删除页面地址
      var BATCH_DEL_URL = "{{ url('api/admin/feeScale/ajax_del') }}";//批量删除页面地址
      var EXPORT_EXCEL_URL = "{{ url('admin/feeScale/export') }}";//导出EXCEL地址
      var IMPORT_EXCEL_TEMPLATE_URL = "{{ url('admin/feeScale/import_template') }}";//导入EXCEL模版地址
      var IMPORT_EXCEL_URL = "{{ url('api/admin/feeScale/import') }}";//导入EXCEL地址
      var IMPORT_EXCEL_CLASS = "import_file";// 导入EXCEL的file的class
  </script>
  <script src="{{asset('js/common/list.js')}}"></script>
  <script src="{{ asset('js/admin/lanmu/feeScale.js') }}"  type="text/javascript"></script>
</body>
</html>