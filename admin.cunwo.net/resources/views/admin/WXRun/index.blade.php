  ...
  <div class="mmhead" id="mywork">
    ...
    <form onsubmit="return false;" class="form-horizontal" role="form" method="post" id="search_frm" action="#">
      <div class="msearch fr" style="width:700px;">
        ...
        <select class="wmini" name="open_status" style="width: 55px;">
...
--}}
  ...
  <script type="text/javascript">
      ...
      var AJAX_URL = "{{ url('api/admin/staffRun/ajax_alist') }}";//ajax请求的url
      var ADD_URL = "{{ url('admin/staffRun/add/0') }}"; //添加url

      var IFRAME_MODIFY_URL = "{{url('admin/staffRun/add/')}}/";//添加/修改页面地址前缀 + id
      var IFRAME_MODIFY_URL_TITLE = "用户" ;// 详情弹窗显示提示  [添加/修改] +  栏目/主题
      var IFRAME_MODIFY_CLOSE_OPERATE = 0 ;// 详情弹窗operate_num关闭时的操作0不做任何操作1刷新当前页面2刷新当前列表页面

      var SHOW_URL = "{{url('admin/staffRun/info/')}}/";//显示页面地址前缀 + id
      var SHOW_URL_TITLE = "" ;// 详情弹窗显示提示
      var SHOW_CLOSE_OPERATE = 0 ;// 详情弹窗operate_num关闭时的操作0不做任何操作1刷新当前页面2刷新当前列表页面
      var EDIT_URL = "{{url('admin/staffRun/add/')}}/";//修改页面地址前缀 + id
      var DEL_URL = "{{ url('api/admin/staffRun/ajax_del') }}";//删除页面地址
      var BATCH_DEL_URL = "{{ url('api/admin/staffRun/ajax_del') }}";//批量删除页面地址
      var EXPORT_EXCEL_URL = "{{ url('admin/staffRun/export') }}";//导出EXCEL地址
      var IMPORT_EXCEL_TEMPLATE_URL = "{{ url('admin/staffRun/import_template') }}";//导入EXCEL模版地址
      var IMPORT_EXCEL_URL = "{{ url('api/admin/staffRun/import') }}";//导入EXCEL地址
      ...
      var STAFF_OPERATE_URL  = "{{url('api/admin/staffRun/ajax_save_operate')}}";// 用户 操作类型 1 提交申请修改信息 ;2 审核通过 3 审核不通过 4 冻结 5 解冻 6 上班 7 下班
...
<script src="{{asset('js/common/list.js')}}"></script>
  <script src="{{ asset('js/admin/lanmu/WXRun.js') }}"  type="text/javascript"></script>
</body>
</html>