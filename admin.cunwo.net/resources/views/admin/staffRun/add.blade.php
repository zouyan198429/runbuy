...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/admin/staffRun/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/staffRun')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/admin/lanmu/staffRun_edit.js') }}"  type="text/javascript"></script>
</body>
</html>