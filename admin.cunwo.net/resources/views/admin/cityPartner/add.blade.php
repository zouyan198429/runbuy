...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/admin/cityPartner/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('admin/cityPartner')}}";//保存成功后跳转到的地址
    ...
    var SELECT_CITY_URL = "{{ url('admin/city/select') }}";// 选择城市分站地址
    var AJAX_CITY_SELECTED_URL = "{{ url('api/admin/city/ajax_selected') }}";// ajax选中城市分站地址
</script>
<script src="{{ asset('/js/admin/lanmu/cityPartner_edit.js') }}"  type="text/javascript"></script>
</body>
</html>